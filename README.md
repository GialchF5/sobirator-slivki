...
- ID функции: `d4elven3m5nubp0gfdk6`
- Каталог Yandex Cloud: `sl`
- Статус: `ACTIVE`
- Runtime: `nodejs22`
- Entry point: `index.handler`
- Версий в экспорте: `3`
- HTTP URL: `https://functions.yandexcloud.net/d4elven3m5nubp0gfdk6`

## Триггеры

- `sobirator-slivki` (`a1seq1kiqaa600beb0ih`), статус: `ACTIVE`, cron: `0 * ? * * *`
...
```powershell
cd .\yc-export-author-gilach\sanitized\functions\sobirator-slivki
...
```powershell
yc serverless function version create --function-id d4elven3m5nubp0gfdk6 --runtime nodejs22 --entrypoint index.handler --source-path . --execution-timeout 60s
```
